...
const article: NewsArticleData = {
  title: "Beijing Jinxi Boyuan Real Estate Co., Ltd", hero: "/figma/news-single/architecture.png", heroAlt: "Contemporary Beijing high-rise architecture",
