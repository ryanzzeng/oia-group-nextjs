...
export default function JinxiDonghuwanPage() {
  return <article className="donghu-news-page">
    <section className="donghu-news-hero"><Image src="/figma/news-donghuwan/hero.png" alt="Glass commercial architecture" fill priority sizes="100vw" /><div className="donghu-news-hero-copy"><span>News</span><h1>Jinxi<br />Donghuwan<br />Project</h1></div></section>
    ...
    <section className="donghu-news-story">
      <div className="donghu-news-aerial"><Image src="/figma/news-donghuwan/aerial.png" alt="Jinxi Donghu Bay residential masterplan" fill sizes="78vw" /></div>
