...
export default function JinxiDonghuwanPage() {
  return <article className="donghu-news-page">
    <section className="donghu-news-hero"><Image src="/figma/news-donghuwan/hero.webp" alt="Glass commercial architecture" fill priority sizes="100vw" /><div className="donghu-news-hero-copy"><span>News</span><h1>Jinxi<br />Donghuwan<br />Project</h1></div></section>
