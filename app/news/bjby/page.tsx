...
export const metadata: Metadata = { title: "Beijing Jinxi Boyuan Real Estate", alternates: { canonical: "/news/bjby/" } };

export default function BeijingJinxiBoyuanPage() {
  return <article className="boyuan-news-page">
    <section className="boyuan-news-hero"><Image src="/figma/news-boyuan/hero-hd.png" alt="Modern Beijing commercial architecture" fill priority quality={95} sizes="100vw" /><div className="boyuan-news-hero-shade" /><div className="boyuan-news-hero-copy"><span>News</span><h1>Beijing Jinxi<br />Boyuan Real<br />Estate</h1></div></section>
    ...
    <section className="boyuan-news-story">
      <div className="boyuan-news-map"><Image src="/figma/news-boyuan/map.png" alt="Beijing Real Estate business locations across China" fill sizes="80vw" /></div>
