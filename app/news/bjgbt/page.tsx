...
export default function BeijingJinxiGreenBuildingPage() {
  return <article className="green-news-page">
    ...
    <section className="green-news-epc">
      ...
      <div className="green-news-image-pair first"><div><Image src="/figma/news-green/pc-plant-plan.webp" alt="New PC plant masterplan" fill sizes="46vw" /></div><div><Image src="/figma/news-green/pc-plant.webp" alt="New PC plant" fill sizes="34vw" /></div></div>
      ...
      <div className="green-news-image-pair second"><div><Image src="/figma/news-green/student-centre-aerial.webp" alt="Student services centre aerial view" fill sizes="40vw" /></div><div><Image src="/figma/news-green/student-centre-render.webp" alt="Student services centre rendering" fill sizes="46vw" /></div></div>
    </section>
    <NewsFeaturedSlider />
    <BrandedFooter />
  </article>;
