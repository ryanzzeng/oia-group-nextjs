...
const article: NewsArticleData = {
  title: "Beijing Jinxi Green Building Technology", hero: "/figma/news-page/city.png", heroAlt: "Beijing waterfront skyline",
